...
@Component({
  ...
  templateUrl: './worker-transaction-update.component.html',
  styleUrls: ['./worker-transaction-update.component.css']
})
export class WorkerTransactionUpdateComponent {
  successMessage: any;
  constructor(
  ...
  onSubmit() {
    let submitModel: workerTransactionSettleMent = {
   ...
   settlementReason: this.Reason,
    ...
    this.loginService
      .workerTransactionSettlements(this.transIdValue, submitModel)
      .subscribe((res: any) => {
