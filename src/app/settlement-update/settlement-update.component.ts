...
@Component({
  selector: 'app-settlement-update',
  templateUrl: './settlement-update.component.html',
  styleUrls: ['./settlement-update.component.css']
})
export class SettlementUpdateComponent {
  successMessage: any;
  constructor(
  ...
  onSubmit() {
   ...
   settlementReason: this.Reason,
    ...
    this.loginService
      .SettlementUpdates(this.transIdValue, submitModel)
      .subscribe((res: any) => {
