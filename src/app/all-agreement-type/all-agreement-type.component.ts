...
@Component({
  selector: 'app-all-agreement-type',
  templateUrl: './all-agreement-type.component.html',
  styleUrls: ['./all-agreement-type.component.css']
})
export class AllAgreementTypeComponent {
  ...
  ngOnInit(): void {
    ...
    this.loginService.Allagreement().subscribe((res: any) => {
      this.agreement = res.response;
...
AllvsitorsType()
{
  ...
  addAgreement()
  {
    this.route.navigateByUrl(`/add-agreement`);
  }
  Dashboard()
  {
    this.route.navigateByUrl(`/dashboard`);
