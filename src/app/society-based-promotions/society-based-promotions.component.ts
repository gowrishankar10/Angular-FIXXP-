...
@Component({
  selector: 'app-society-based-promotions',
  templateUrl: './society-based-promotions.component.html',
  styleUrls: ['./society-based-promotions.component.css']
})
export class SocietyBasedPromotionsComponent {
  http: any;
  ...
  addpromotion() {
    ...
    input.append('societyId ', this.societyId);
  ...
  processFile(imageInput: any) {
    ...
    reader.addEventListener('load', (event: any) => {
      ...
      this.ImagePromotionService.updateImagesociety(formData).subscribe((res: any) => {
